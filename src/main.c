...
static QueueHandle_t hButtonQueue;
static StaticQueue_t xStaticQueue;
static uint8_t ucQueueStorage[MSG_QUEUE_LEN * sizeof(ButtonMsg_t)];
...
void freertos_tasks_init(void)
{
	...
	hButtonQueue = xQueueCreateStatic(MSG_QUEUE_LEN, sizeof(ButtonMsg_t), ucQueueStorage, &xStaticQueue);
#ifdef DEBUG
	...
	static StackType_t xAppStack[ configMINIMAL_STACK_SIZE * 10 ];
