...
#error "newlib_lock_glue.c" used with GNU Compilers only
...
/** Implementing mutex from newlib.
  *  <a href="https://sourceware.org/git/?p=newlib-cygwin.git;a=blob_plain;f=newlib/libc/misc/lock.c">
  * newlib/libc/misc/lock.c</a> */
